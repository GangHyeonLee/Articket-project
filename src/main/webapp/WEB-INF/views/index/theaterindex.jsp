...
<div class="container-fluid">
        ...
        <section class="py-5-1">
            <div class="container px-7 px-lg-1 mt-2">
                <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-5 justify-content-center" style="padding-bottom: 1.7%;">
                    ...
                    <a href="<c:url value='/theaterdetail?rnum=0'/>">
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=1'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=2'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=3'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=4'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=5'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=6'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=7'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=8'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=9'/>">
                            <div class="card h-100">
                               <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=10'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=11'/>">
                            <div class="card h-100">
                                <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=12'/>">
                            <div class="card h-100">
                               <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=13'/>">
                            <div class="card h-100">
                                 <!-- Product image-->
                    ...
                    <div class="col mb-5" style="padding-right: 1%;">
                        <a href="<c:url value='/theaterdetail?rnum=14'/>">
                            <div class="card h-100">
                               <!-- Product image-->
        ...
        <!-- Core theme JS-->
        <script src="resources/js/index/theater_scripts.js"></script>
